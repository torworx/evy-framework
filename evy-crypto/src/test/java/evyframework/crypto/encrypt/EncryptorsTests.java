...
import evyframework.crypto.encrypt.TextEncryptor;
...
public class EncryptorsTests {
    ...
    public void standard() throws Exception {
        ...
        byte[] result = encryptor.encrypt("文本".getBytes("UTF-8"));
        assertNotNull(result);
        assertFalse(new String(result).equals("文本"));
        assertEquals("文本", new String(encryptor.decrypt(result)));
        assertFalse(new String(result).equals(new String(encryptor.encrypt("文本".getBytes()))));
    }
