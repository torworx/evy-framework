...
public abstract class FieldAccess {
	...
	static public FieldAccess get (Class<?> type) {
		...
		synchronized (loader) {
			try {
				...
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "evyframework/reflectasm/FieldAccess",
					null);
	...
	static private void insertConstructor (ClassWriter cw) {
		...
		mv.visitMethodInsn(INVOKESPECIAL, "evyframework/reflectasm/FieldAccess", "<init>", "()V");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}
