...
package evyframework.reflectasm;
...
import evyframework.asm.ClassWriter;
import evyframework.asm.Label;
import evyframework.asm.MethodVisitor;
import evyframework.asm.Opcodes;
import evyframework.asm.Type;

import static evyframework.asm.Opcodes.*;
	...
	static public MethodAccess get (Class<?> type) {
		...
		synchronized (loader) {
			try {
				...
				MethodVisitor mv;
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "evyframework/reflectasm/MethodAccess",
					null);
				{
					mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
					mv.visitCode();
					mv.visitVarInsn(ALOAD, 0);
					mv.visitMethodInsn(INVOKESPECIAL, "evyframework/reflectasm/MethodAccess", "<init>", "()V");
					mv.visitInsn(RETURN);
					mv.visitMaxs(0, 0);
					mv.visitEnd();
				}
