...
import evyframework.reflectasm.FieldAccess;
	...
	public void testDifferentClassloaders() throws Exception {
		...
		ClassLoader testClassLoader = new ClassLoader() {
			...
			protected synchronized Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
				...
				if (!name.equals("evyframework.reflectasm.ClassLoaderTest$Test"))
		...
		Class<?> testClass = testClassLoader.loadClass("evyframework.reflectasm.ClassLoaderTest$Test");
