...
package evyframework.reflectasm.benchmark;
...
public class Benchmark {
	...
	public HashMap<String, Long> testTimes = new HashMap<String, Long>();
	private long s;
	...
	public void chart (String title) {
		...
		ArrayList<Entry> list = new ArrayList<Entry>(testTimes.entrySet());
