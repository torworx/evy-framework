 ...
 */
public class LocalThreadSingletonFactory extends LocalFactoryBase implements LocalFactory {
	public LocalFactory sourceFactory = null;
	public Map<Thread, Object> instances = new HashMap<Thread, Object>();

	public LocalThreadSingletonFactory(LocalFactory sourceFactory) {
