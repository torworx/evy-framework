...
/**
 * This factory returns one of the input parameters given to the instance call as its product. This is handy when
 * another factory needs one of the input parameters. Rather than having to know that one of the objects needed comes
 * from the input array, the given factory only calls the factories it depends upon, some of which may return object
 * obtained from the input parameter array. This gives a more uniform way of using other factories and input parameters.
 * No factory except this factory need be aware of the input parameters. They just need to pass them on, that's all.
 */

public class InputConsumerFactory extends LocalFactoryBase implements LocalFactory {
	...
	public Object instance(Object[] parameters, Object[] localProducts) {
		...
		if (this.inputParameterIndex >= parameters.length)
			return null;
