package evyframework.common.collect;
...
/* ------------------------------------------------------------ */
/**
 * Lazy List creation. A List helper class that attempts to avoid unnecessary
 ...
 * {@link Collections#EMPTY_LIST} or {@link Collections#singletonList(Object)}
 * where possible.
 * <p>
...
public class LazyList implements Cloneable, Serializable {
	...
	public static <T> T[] addToArray(T[] array, T item, Class<?> type) {
		if (array == null) {
			...
			// TODO: Replace with Arrays.copyOf(T[] original, int newLength)
			// from Java 1.6+
