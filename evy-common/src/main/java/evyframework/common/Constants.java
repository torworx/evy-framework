 ...
 * <code>public final static int CONSTANT1 = 66;</code> An instance of this
 * class wrapping <code>Foo.class</code> will return the constant value of 66
 * from its <code>asNumber</code> method given the argument
 * <code>"CONSTANT1"</code>.
 * 
 * <p>
...
public class Constants {
	 ...
	 *             if the supplied <code>clazz</code> is <code>null</code>
	 */
	...
	/**
	 * Exposes the field cache to subclasses: a Map from String field name to
	 * object value.
	 */
	 ...
	 * 
	 * @param code
	 *            the name of the field (never <code>null</code>)
	 * @return the Number value
	 * @see #asObject
	 * @throws ConstantException
	 *             if the field name wasn't found or if the type wasn't
	 ...
	 * <p>
	 * Note that this method assumes that constants are named in accordance with
	 * the standard Java convention for constant values (i.e. all uppercase).
	 * The supplied <code>namePrefix</code> will be uppercased (in a
	 * locale-insensitive fashion) prior to the main logic of this method
	 * kicking in.
	 * 
	 * @param namePrefix
	 *            prefix of the constant names to search (may be
	 *            <code>null</code>)
	...
	/**
	 * Return all names of the group of constants for the given bean property
	 * name.
	 * 
	 * @param propertyName
	 ...
	 * Note that this method assumes that constants are named in accordance with
	 * the standard Java convention for constant values (i.e. all uppercase).
	 * The supplied <code>nameSuffix</code> will be uppercased (in a
	 * locale-insensitive fashion) prior to the main logic of this method
	 * kicking in.
	 * 
	 * @param nameSuffix
	 *            suffix of the constant names to search (may be
	 *            <code>null</code>)
	 * @return the set of constant names
	 */
	...
	/**
	 * Return all values of the group of constants for the given bean property
	 * name.
	 * 
	 * @param propertyName
	 *            the name of the bean property
	 ...
	 * <p>
	 * Uses a common naming idiom: turning all lower case characters to upper
	 * case, and prepending upper case characters with an underscore.
	 * <p>
