...
import evyframework.common.io.FileAsDefaultResourceLoader;
...
public abstract class ResourcePatternUtils {
	 ...
	 * @see evyframework.common.ResourceUtils#CLASSPATH_URL_PREFIX
	 * @see evyframework.common.ResourceUtils#isUrl(String)
	 * @see java.net.URL
	 */
	...
	public static ResourcePatternResolver getDefaultResourcePatternResolver() {
		return getResourcePatternResolver(null);
	}
	
	public static ResourcePatternResolver getFileAsDefaultResourcePatternResolver() {
		return getResourcePatternResolver(new FileAsDefaultResourceLoader());
	}
