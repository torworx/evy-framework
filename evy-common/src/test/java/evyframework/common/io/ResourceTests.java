...
public class ResourceTests {
	...
	public void testByteArrayResource() throws IOException {
		...
		String content = FileUtils.copyToString(new InputStreamReader(resource.getInputStream()));
	...
	public void testClassPathResource() throws IOException {
		Resource resource = new ClassPathResource("evyframework/common/io/Resource.class");
		doTestResource(resource);
		Resource resource2 = new ClassPathResource("evyframework/common/../core/io/./Resource.class");
		assertEquals(resource, resource2);
		Resource resource3 = new ClassPathResource("evyframework/common/").createRelative("../core/io/./Resource.class");
	...
	public void testClassPathResourceWithClassLoader() throws IOException {
		Resource resource =
				new ClassPathResource("evyframework/common/io/Resource.class", getClass().getClassLoader());
		doTestResource(resource);
		assertEquals(resource,
				new ClassPathResource("evyframework/common/../core/io/./Resource.class", getClass().getClassLoader()));
	}
