...
package evyframework.common.io.support;
...
public class PathMatchingResourcePatternResolverTests {
	...
	private static final String[] CLASSES_IN_COMMONSLOGGING =
			new String[] {"ILoggerFactory.class", "IMarketFactory.class",
										"Logger.class", "LoggerFactory.class", "Marker.class",
										"MarkerFactory.class", "MDC.class"};
	...
	public void testSingleResourceOnFileSystem() throws IOException {
		Resource[] resources =
				resolver.getResources("evyframework/common/io/support/PathMatchingResourcePatternResolverTests.class");
		assertEquals(1, resources.length);
		assertProtocolAndFilename(resources[0], "file", "PathMatchingResourcePatternResolverTests.class");
	}
	
	@Test
	public void testSubResourcesOnFileSystem() throws IOException {
		Resource resource = resolver.getResource("evyframework/common/io/support");
		assertTrue(resource.getFile().isDirectory());
		String classResourcePath = "file:" + resource.getFile().getAbsolutePath() + "/*.class";
		Resource[] resources = resolver.getResources(classResourcePath);
	...
	public void testClasspathStarWithPatternOnFileSystem() throws IOException {
		Resource[] resources = resolver.getResources("classpath*:evyframework/common/io/sup*/*.class");
	...
	public void testClasspathWithPatternInJar() throws IOException {
		Resource[] resources = resolver.getResources("classpath:org/slf4j/*.class");
